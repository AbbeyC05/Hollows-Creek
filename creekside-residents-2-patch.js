(() => {
  const people = {
    'Harry Porter': {
      id:'harryPorterProfile', img:'harry-porter-profile.png',
    ...
    'Max Ford': {
      id:'maxFordProfile', img:'max-ford-profile.png',
      facts:[['Born','1980'],['Residence',"Southside, Hollow's Creek"],['Education','Creekside High'],['Species','Human']],
    ...
    'Clarke Hudson': {
      id:'clarkeHudsonProfile', img:'clarke-hudson-profile.png',
      facts:[['Born','1980'],['Residence',"Southside, Hollow's Creek"],['Education','Creekside High'],['Species','Human']],
    ...
    'Molly Winter': {
      id:'mollyWinterProfile', img:'molly-winter-profile.png',
      facts:[['Born','1980'],['Residence',"Southside, Hollow's Creek"],['Education','Creekside High'],['Species','Human']],
      sections:[['Relationships',['Samuel Sinclair — ex']]]
    },
    'Piper Ellwood': {
      id:'piperEllwoodProfile', img:'piper-ellwood-profile.png',
      facts:[['Born','1980'],['Residence',"Southside, Hollow's Creek"],['Education','Creekside High'],['Species','Human']],
      sections:[['Relationship',['Max Ford — boyfriend']],['Friends',['Poppy Carter','Georgia Carter','Kasey Ford']]]
    },
    'Kasey Ford': {
      id:'kaseyFordProfile', img:'kasey-ford-profile.png',
  ...
  function install(){
    ...
    if(!holding){holding=document.createElement('section');holding.id='creekside-residents-2';holding.className='letter-group';holding.innerHTML='<div class="letter">?</div><div class="resident-list"></div>';wrap.appendChild(holding);}
