(() => {
  ...
  const install = () => {
    ...
    if (residentsWrap) {
      ...
      for (const name of ['Claribel Montague','Isabella Montague','Thomas Marvolo Montague II','Thomas Marvolo Montague III']) {
