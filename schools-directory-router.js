...
function install(){
 ...
 document.querySelectorAll('.lbp-nav .back,.cr-nav .back').forEach(b=>{b.textContent='Schools ↗';b.onclick=()=>showPage('schools')});
}
